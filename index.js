...
const sizes = {
  short: {
    ...
    coverage: "Передай лише найважливіші теми. Другорядні теми свідомо опусти.",
    maxTokens: 500
  },

  medium: {
    instruction: "3-4 абзаци по 2-3 речення.",
    coverage: "Передай усі основні теми. Для кожної теми залиш лише ключові факти.",
    maxTokens: 1200
  },

  long: {
    instruction: "5-7 абзаців по 2-3 речення. Це має бути резюме, а не переписаний текст.",
    coverage: "Передай всі основні теми. Для кожної теми залиш лише найважливіші факти. Другорядні деталі, приклади та повтори скорочуй або опускай.",
    maxTokens: 2200
  }
};
