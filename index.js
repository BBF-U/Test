...
================================= */
const sizes = {
  short:  { instruction: "РІВНО 3 речення.", maxTokens: 400 },
  medium: { instruction: "РІВНО 6 речень.", maxTokens: 800 },
  long:   { instruction: "РІВНО 10 речень.", maxTokens: 1400 }
};
...
ОБМЕЖЕННЯ ОБСЯГУ (ОБОВʼЯЗКОВО ДО ВИКОНАННЯ): ${instruction}

ЗАВДАННЯ:
Зроби стисле резюме наданого тексту. Скороти обсяг, зберігши всі фактичні дані.

ВАЖЛИВО:
- не перевищуй цей обсяг
- якщо текст довгий — стискай формулювання
- дотримуйся рівно цього обсягу
