...
const sizes = {
  ...
  medium: { instruction: "3-4 абзаци по 2-3 речення. Охопи всі ключові теми.", maxTokens: 800 },
  long:   { instruction: "5-7 абзаців по 2-3 речення. Максимально повно з усіма фактами.", maxTokens: 1500 }
};
...
Створи компактне резюме без втрати ключових фактів.
