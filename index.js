...
ФОРМАТ:
- Короткі абзаци для обсягу medium та long 
- Суцільний текст без списків та без Markdown
- Розбивай для обсягу medium та long на абзаци через порожній рядок між ними
...
ФОРМАТ:
- Речення для обсягу medium та long суцільним текстом
...
- Далі: абзаци з деталями
- Тільки суцільний текст, без списків, без Markdown
- Розбивай на абзаци через порожній рядок між ними
