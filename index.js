...
ЗАВДАННЯ:
Зроби максимально точне резюме тексту.

КРИТИЧНО ВАЖЛИВО:
- ЗБЕРІГАЙ всі числа, дати і роки БЕЗ ЗМІН
- якщо в тексті є 2030 → залиш 2030
- НЕ замінюй числа навіть якщо вони здаються неправильними
...
- не інтерпретуй
- не узагальнюй
- використовуй тільки інформацію з тексту
